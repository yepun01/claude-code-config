...
This agent applies **CC-4 (falsifiability)** from `~/.claude/docs/agent-synergy.md`. CC-4 = every CRITICAL/Warning vulnerability includes a `*Refutable by:*` line specifying the test/evidence that would prove it's NOT exploitable.
<!-- CC-END id=CC-4 -->
...
<!-- CC-START id=CC-4 -->
  - *Refutable by:* [concrete test/evidence that would prove this is NOT exploitable in practice]
<!-- CC-END id=CC-4 -->
...
- [OWASP-AXX|EXEC-INDIRECT] [description] — file:line
  - Fix: [correction]
<!-- CC-START id=CC-4 -->
  - *Refutable by:* [concrete test/evidence]
<!-- CC-END id=CC-4 -->
...
<!-- CC-START id=CC-4 -->
- **PASS**: 0 exploitable vuln, 0 exposed secret, **Refutable-by gate >= 80%** (≥80% of CRITICAL/Warning have non-trivial Refutable-by line)
- **FAIL_WARNING**: Warnings only (misconfig, missing headers) OR Refutable-by gate < 80%
<!-- CC-END id=CC-4 -->
